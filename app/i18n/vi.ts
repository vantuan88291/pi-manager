...
const vi: Translations = {
  ...
  fileManager: {
    ...
    download: "Tải xuống",
    rename: "Đổi tên",
    move: "Chuyển tới thư mục…",
    renameTitle: "Đổi tên “{{name}}”",
    renameHint: "Chỉ tên mới (không ghi đường dẫn).",
    renamePlaceholder: "Tên mới",
    moveTitle: "Chuyển “{{name}}”",
    moveHint: "Nhập đường dẫn đầy đủ tới thư mục đích trên Pi (thư mục phải tồn tại).",
    movePlaceholder: "/home/user/Documents",
    downloadSuccess: "Đã tải {{name}}.",
    downloadFailed: "Không tải được file.",
    downloadErrorTitle: "Tải xuống thất bại",
    renamed: "Đã đổi tên",
