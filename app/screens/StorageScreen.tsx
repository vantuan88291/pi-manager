...
export const StorageScreen: FC = function StorageScreen() {
  ...
  const getHealthStatus = (percentageUsed: number) => {
    if (percentageUsed < 80)
      return {
        label: t("storage:health.good"),
        color: theme.colors.success,
        icon: "checkmark-circle",
      }
    if (percentageUsed < 95)
      return {
        label: t("storage:health.warning"),
            ...
            <View>
              <View style={[$healthHeader, { backgroundColor: healthStatus?.color + "15" }]}>
                ...
                <View style={$healthInfo}>
                  ...
                  <Text
                    text={healthStatus?.label || "Unknown"}
                    size="lg"
                    weight="semiBold"
                    color={healthStatus?.color || theme.colors.text}
                  />
                ...
                {warningLevel.count > 0 && (
                  <Badge
                    ...
                    color={
                      warningLevel.level === "critical" ? theme.colors.error : theme.colors.warning
                    }
                  />
                )}
              </View>
              ...
              <Text
                text={storageStatus?.model || "NVMe SSD"}
                size="md"
                weight="semiBold"
                color="text"
                style={{ marginTop: 16 }}
              />
              <Text
                text={`${storageStatus?.interface || "NVMe"} • ${storageStatus?.serial ? storageStatus.serial.slice(0, 8) + "..." : ""}`}
                size="sm"
                color="textDim"
              />
          ...
          ContentComponent={
            <View>
              ...
              <SmartDetailRow
                ...
                iconColor={
                  health.unsafeShutdowns > 10 ? theme.colors.warning : theme.colors.success
                }
              />
              <SmartDetailRow
              ...
              <SmartDetailRow
                ...
                iconColor={
                  health.errorLogEntries > 100 ? theme.colors.warning : theme.colors.textDim
                }
              />
              <SmartDetailRow
    ...
    <View style={themed([$detailRow, $borderTop])}>
      <View style={$detailLeft}>
        <Icon
          font="Ionicons"
          icon={icon}
          color={iconColor || (warning ? theme.colors.error : theme.colors.success)}
          size={18}
        />
      ...
      <Text
        ...
        size="sm"
        weight="semiBold"
        color={warning ? theme.colors.error : theme.colors.text}
      />
    </View>
  )
}
...
const $healthIconBadge: ViewStyle = {
  width: 48,
  height: 48,
  borderRadius: 24,
  alignItems: "center",
