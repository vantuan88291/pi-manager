            ...
            <View>
              ...
              <View style={themed([$settingRow, $borderBottom])}>
                ...
                <View style={$statusBadge}>
                  <View
                    style={[$statusDot, { backgroundColor: theme.colors[connectionStatus.color] }]}
                  />
                  <Text
                    tx={connectionStatus.text}
