const en = {
  ...
  welcomeScreen: {
    postscript: "This is the welcome screen. You can customize it as you like.",
  ...
  reboot: {
    title: "Reboot",
    message:
      "Are you sure you want to reboot Raspberry Pi? The app will lose connection during this process.",
    confirm: "Reboot",
    cancel: "Cancel",
    rebooting: "Rebooting...",
  ...
  fileManager: {
    ...
    typeNounFolder: "folder",
    typeNounFile: "file",
    placeholderFolderName: "Folder name…",
    placeholderFileName: "File name…",
    createFailed: "Failed to create {{type}}",
    modifiedYesterday: "Yesterday",
    modifiedDaysAgo: "{{count}} days ago",
    rename: "Rename",
    move: "Move to folder…",
    renameTitle: "Rename “{{name}}”",
    renameHint: "New name only (no path).",
    renamePlaceholder: "New name",
    moveTitle: "Move “{{name}}”",
    moveHint: "Enter the full path of an existing folder on the Pi.",
